...
[mctrace](https://github.com/jakob-garde/mctrace) is a visualization tool built with code generated by the
[mcparse](https://github.com/jakob-garde/mcparse) project. (See the mcparse README for further details.)

It utilizes the mcstas components and simulation core without relying on current tooling.
...
simulation code, making "simulation intrinsics" available at the tool level.
