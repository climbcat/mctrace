...
#ifndef __READ_TABLE_LIB_H__
#define __READ_TABLE_LIB_H__
...
#ifndef __INTEROFF_LIB_H__
#define __INTEROFF_LIB_H__
...
#ifndef __MONITOR_ND_LIB_H__
#define __MONITOR_ND_LIB_H__
...
#pragma acc routine
int Monitor_nD_Trace(MonitornD_Defines_type *, MonitornD_Variables_type *, Neutron* _particle);
...
/* token modifiers */
    ...
    if (Vars->Flag_Verbose)
    {
      ...
      printf("Monitor_nD: version (undefined) with options=%s\n", Vars->option);
    }
...
#ifndef __REF_LIB_H__
#define __REF_LIB_H__
